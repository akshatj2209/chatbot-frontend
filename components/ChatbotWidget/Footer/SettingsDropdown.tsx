    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56">
                ...
                {languages.map((lang) => (
                    <DropdownMenuItem key={lang} className="cursor-pointer" onClick={() => setSelectedLanguage(lang)}>
                        <span className={cn("text-sm", selectedLanguage === lang ? "text-gray-800 font-semibold" : "text-gray-400")}>{lang}</span>
                    </DropdownMenuItem>
                ))}
            </DropdownMenuContent>
        </DropdownMenu>
